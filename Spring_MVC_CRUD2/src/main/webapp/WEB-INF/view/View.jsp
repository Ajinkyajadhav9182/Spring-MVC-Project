...
<body>
	<center>
		...
		<nav class="navbar background">
			<div class="rightNav">
				<input type="text" name="searchdata" id="search">
				<button class="btn btn-sm">Search</button>
			</div>
		</nav>
		<br> <br>
		<div class="container">
			<table style="border-radius: 20px" id="search">
				<thead>
			...
			<br> <br> <br>
			<center>
				<a href="register">Back</a> <br> <br> <a href="register">Register</a>
			</center>
		</div>
	</center>
