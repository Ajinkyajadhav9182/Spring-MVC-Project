	...
	<form action="add">
		<div class="container">
			...
			<label> Name : </label> <input type="text" name="name"
				placeholder="Enter Name" required /> <label> Phone : </label> <input maxlength="10" 
				type="text" name="mobileno" placeholder="Phone No" required>
			<label for="email"> Email : </label> <input type="text"
				placeholder="Enter Email" name="email" required> Current
